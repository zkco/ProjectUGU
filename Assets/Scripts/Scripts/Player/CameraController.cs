...
public class CameraController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        xRotationValue -= mouseDelta.y;
        yRotationValue += mouseDelta.x;
        cameraPivot.rotation = Quaternion.Euler(Mathf.Clamp(xRotationValue, -angleClamp, angleClamp), yRotationValue, 0);
